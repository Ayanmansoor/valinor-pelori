...
function Discount({ categoryName }) {
  ...
  return (
    <>
      <section className='w-full mb-10 relative h-auto bg-black  py-10 border '>
        <section className='w-full   relative min-h-[200px]  bg-black grid grid-cols-1   md:gap-0 md:grid-cols-[2fr_1.5fr]  gap-10 '>
          ...
          <div className='w-full relative h-full flex items-start justify-center flex-col gap-1 container  md:pl-20  '>
            <h2 className='text-h1 font-semibold text-white '>Limited Time Luxury</h2>
            <p className='text-lg font-normal w-full md:w-4/5 text-white '>Step into Elegance at Unbeatable Prices. Discover our finest selection of luxury shoes on exclusive discount.</p>
